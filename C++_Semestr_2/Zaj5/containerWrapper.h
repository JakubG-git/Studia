...
public:
    ...
    VectorWrapper(const value_type arr[], long long size);
    void push_back(const value_type& el) override;
    void push_front(const value_type& el) override;
    void insert(const value_type& el, size_t position) override;
    value_type& at(size_t position) override;
    size_t size() const override { return this->impl_.size(); }
    void sort() override;
    ...
    size_t find(const value_type& val) const override;
...
public:
    VectorPreallocatedWrapper() = default;
    VectorPreallocatedWrapper(const value_type arr[], long long size);
    void push_back(const value_type& el) override;
    void push_front(const value_type& el) override;
    void insert(const value_type& el, size_t position) override;
    value_type& at(size_t position) override;
...
public:
    ListWrapper() = default;
    ListWrapper(const value_type arr[], long long size);
    void push_back(const value_type& el) override;
    void push_front(const value_type& el) override;
    void insert(const value_type& el, size_t position) override;
    value_type& at(size_t position) override;
...
public:
    ...
    DequeWrapper(const value_type arr[], long long size);
    void push_back(const value_type& el) override;
    void push_front(const value_type& el) override;
    void insert(const value_type& el, size_t position) override;
    value_type& at(size_t position) override;
